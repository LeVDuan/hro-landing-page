...
export const FaqsData: FaqsDataTypes[] = [
  ...
  },
  {
    ...
    active: true,
    answer:
      'Chúng tôi thường tổ chức tuyển thành viên vào khoảng tháng 10. Chúng mình thường sẽ tuyển thành viên sau 3 vòng: vòng đơn, vòng phỏng vấn và vòng tryout, với 3 vị trí ứng tuyển: Manager, Media và Player. Nếu bạn yêu thích, muốn tìm hiểu, thỏa mãn đam mê với bóng chày, hãy đến với HRO!'
  },
  {
    id: 'panel3',
