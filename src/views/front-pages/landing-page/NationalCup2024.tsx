    ...
    <section className='flex flex-col gap-16 plb-[50px]'>
      ...
      >
        <div className='md:max-is-[485px] flex flex-col items-start gap-y-4 gap-x-4 pbs-9 lg:plb-9 z-[1]'>
          <div className='flex flex-col gap-1'>
            <Typography variant='h5' className='font-bold uppercase'>
              Cúp các Câu lạc bộ Bóng chày toàn quốc năm 2024 - Cúp Đại sứ Hàn Quốc
            </Typography>
          </div>
          <div>
        ...
        <div className='flex pbs-4 lg:pbs-[60px] md:pie-4 z-[1]'>
          <img
            src='/images/front-pages/landing-page/nationalCup2024.png'
...
export default NationalCup2024
